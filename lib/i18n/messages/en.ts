...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "map.overviewHint": "Main and its direct agents. Open a coordinator to see its own branch; search reaches nested or unconnected agents.",
    ...
    "map.fullRoster": "Main's direct agents",
