...
async function liveControllerFixture(t, profiles = {}, fixtureOptions = {}) {
  ...
  const controller = createSubagentController({
    ...
    async createServices(options) {
      ...
      const extensions = options.resourceLoaderOptions.extensionsOverride
        ...
        : [];
      return { __testCwd: options.cwd, resourceLoader: { getExtensions: () => ({ extensions }) } };
    },
  ...
  return {
    cwd, rootId, sessions, blockers, start, controller, get serviceCalls() { return serviceCalls; },
    async cleanup() {
