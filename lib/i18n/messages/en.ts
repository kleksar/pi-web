...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "map.overviewHint": "This overview shows who can launch whom. Open a coordinator’s branch for required results and data sources. Search also finds unconnected agents.",
    "map.branchHint": "These links belong to this coordinator. Choose a connection type to see its role in the workflow.",
