...
test("removes the language selector when English is the only UI language", () => {
  assert.doesNotMatch(panelSource, /settings-language-options|setLocale\(/);
  assert.doesNotMatch(cssSource, /\.settings-language-option/);
});
