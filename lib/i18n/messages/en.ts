...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.sharedContext": "Showing shared Git and global resources. Open a project to edit project settings.",
    "settings.sharedContextFailed": "Could not prepare shared settings: {error}",
    ...
    "skills.scope.repository": "shared roster (Git)",
    "skills.repositoryManaged": "Edit this skill in the Git repository. Its contents are read-only here.",
    "skills.searchInstalled": "Filter available skills...",
    "skills.noMatches": "No matching skills",
    "main.title": "Main agent",
    "main.globalDescription": "Main's built-in tools, skills, extension tools, and direct agents apply across projects. System instructions may have a project-specific file.",
    "main.projectDescription": "Project settings override only the fields you edit. Other settings inherit from Global and are tracked in the project repository.",
    "main.rosterDescription": "Shared default Main policy lives in the versioned Pi Web repository. Local Global and trusted Project settings may override it.",
    "main.configScope": "Main configuration scope",
    "main.projectScope": "Project (in Git)",
    "main.rosterScope": "Shared roster (in Git)",
    "main.rosterPath": "orchestration/main-agent-config.json",
    "main.globalScope": "Global (this machine)",
    "main.projectNeedsTrust": "Trust this checkout before saving or loading its Main settings. Trusting also activates other project resources.",
    "main.trustProject": "Trust project",
    "main.projectSkillsHint": "Only skills inside this repository's .pi/skills can be assigned here. Inherited global skills are configured under Global. Clear the inherited selection before assigning project skills.",
    "main.inheritSkills": "Inherit global skills",
    "main.inheritTools": "Inherit global extension tools",
    "main.inheritBuiltInTools": "Inherit global built-in tools",
    "main.builtInTools": "Main built-in tools",
    "main.builtInToolsDescription": "Limit the built-in tools Main can call. Session tool presets cannot enable tools outside this list. Delegation and extension tools are configured separately.",
    "main.configuredBuiltInTools": "Use Pi's configured built-in tools.",
    "main.limitBuiltInTools": "Limit built-in tools",
    "main.useConfiguredBuiltInTools": "Use configured tools",
    "main.noBuiltInTools": "No built-in tools assigned; delegation is configured separately.",
    "main.inheritDelegation": "Inherit global delegation",
    "main.instructions": "System instructions",
    "main.resources": "Tools and skills",
    "main.resourcesDescription": "Choose the tools Main can call and the skills it sees. Skill instructions do not grant tool permissions. Legacy settings still expose all resources until you make a selection.",
    "main.delegation": "Delegation",
    "main.openMap": "Open orchestration map",
    "main.unsavedMapConfirm": "Main has unsaved changes. The map shows saved settings. Open it anyway?",
    "main.retryProfiles": "Retry loading agents",
    "main.unrestrictedDescription": "Main can call any enabled sub-agent until you limit its direct children.",
    "main.limitChildren": "Limit direct child agents",
    "main.removeRestrictions": "Allow all enabled agents",
    "main.allowedChildren": "Allowed direct agents",
    "main.allowedDescription": "These are Main's direct children. Each orchestrator has its own allowed children.",
    "main.missingChild": "Unavailable in this project; remove before saving",
    "main.noDirectAgents": "Main cannot delegate until you select a direct agent.",
    "main.searchChildren": "Search agents...",
    "main.dependencies": "Agent depends on…",
    "main.dependsOnCount": "depends on {count}",
    "main.noDependencies": "no dependencies",
    "main.reloadRequired": "Reload the current session to apply these changes.",
    "main.reloadSession": "Reload session",
    "main.reloading": "Reloading...",
    "main.save": "Save Main settings",
    "main.saving": "Saving...",
    "main.loading": "Loading Main settings...",
    "main.saved": "Main settings saved.",
    "main.noAgents": "No enabled agents available",
    "main.noMatches": "No matching agents",
    "main.unavailableChildren": "Unavailable child agents: {names}. Remove or enable them before saving.",
    "main.configChanged": "Main settings changed on disk. Reload and review your edits.",
    "main.newSessionsOnly": "Changes to Main's resources and delegation apply to new sessions. Existing sessions keep their pinned setup.",
    "main.savedNewSessions": "Saved. New Main sessions use these settings.",
    "main.reviewLatest": "Latest saved settings",
    "main.useLatest": "Use latest",
    "main.keepEdits": "Keep my edits (review before saving)",
    "mainPrompt.aria": "Main system prompt addendum",
    "mainPrompt.title": "System prompt addendum",
    "mainPrompt.description": "Edit Main's effective prompt. A trusted project file overrides a local global experiment, which overrides the repository default.",
    "mainPrompt.loading": "Loading prompt…",
    "mainPrompt.scope": "Prompt file scope",
    "mainPrompt.global": "Local global experiment",
    "mainPrompt.repository": "Repository",
    "mainPrompt.repositoryTracked": "This file lives in the repository checkout. Commit and push saved changes after review.",
    "mainPrompt.activeSource": "Active source: {scope} · {path}",
    "mainPrompt.project": "Project",
    "mainPrompt.effective": "Effective",
    "mainPrompt.inactive": "Inactive",
    "mainPrompt.file": "File:",
    "mainPrompt.missing": "This file does not exist yet. Save to create it.",
    "mainPrompt.overridden": "Overridden by the trusted project file.",
    "mainPrompt.untrusted": "This project is not trusted. Its prompt will be ignored until project trust is granted.",
    "mainPrompt.instructions": "Prompt instructions",
    "mainPrompt.placeholder": "Instructions for the Main session…",
    "mainPrompt.conflict": "The file changed after it was opened. Your edits are kept. Review the latest version before saving.",
    "mainPrompt.latest": "Latest version on disk",
    "mainPrompt.empty": "(empty file)",
    "mainPrompt.useLatest": "Use latest version",
    "mainPrompt.keepEdits": "Keep my edits (save over latest)",
    "mainPrompt.savedReload": "Saved. Reload the current session to apply the new prompt.",
    "mainPrompt.newSessions": "Changes to the effective prompt apply to new sessions.",
    "mainPrompt.reloading": "Reloading…",
    "mainPrompt.reloadSession": "Reload session",
    "mainPrompt.saving": "Saving…",
    "mainPrompt.save": "Save prompt",
    "mainPrompt.create": "Create prompt",
    "agentResources.assign": "Assign discovered resources to this agent",
    "agentResources.refresh": "Refresh catalog",
    "agentResources.loading": "Loading available resources…",
    "agentResources.loadError": "Cannot load resources: {error}",
    "agentResources.untrusted": "Project resources are hidden until this project is trusted. Existing assignments are preserved.",
    "agentResources.assignedSkills": "Assigned skills",
    "agentResources.skillsAll": "Skills · all available",
    "agentResources.skillsCount": "Skills · {count} selected",
    "agentResources.resolveSkills": "Resolve unavailable skills before preserving the current selection",
    "agentResources.chooseSkills": "Choose specific skills",
    "agentResources.startEmpty": "Start empty",
    "agentResources.searchSkills": "Search skills",
    "agentResources.searchSkillsPlaceholder": "Search skills by name, description, or source",
    "agentResources.hiddenSkill": "{description} · hidden from model prompt",
    "agentResources.noSkills": "No matching skills",
    "agentResources.missingSkill": "Unavailable skill (assignment preserved)",
    "agentResources.assignedTools": "Assigned extension tools",
    "agentResources.toolsAll": "Extension tools · all available",
    "agentResources.toolsCount": "Extension tools · {count} selected",
    "agentResources.resolveTools": "Resolve unavailable or duplicate tools before preserving the current selection",
    "agentResources.chooseTools": "Choose specific tools",
    "agentResources.searchTools": "Search extension tools",
    "agentResources.searchToolsPlaceholder": "Search tools by name, description, or extension",
    "agentResources.noTools": "No matching extension tools",
    "agentResources.missingTool": "Unavailable tool: {name} (assignment preserved)",
    "agentResources.showPath": "Show source path",
    "agentResources.resolvedPath": "Resolved file:",
    "agentResources.warnings": "Resource discovery warnings ({count})",
    "map.title": "Orchestration map",
    "map.path": "Orchestration path",
    "map.allAgents": "All agents",
    "map.search": "Find agents",
    "map.searchPlaceholder": "Find agent…",
    "map.showAllDirectAgents": "Show all",
    "map.showAllConnections": "All connections",
    "map.overviewHint": "Every agent and configured link across the roster. Select an agent to highlight its connections; open a coordinator to edit its branch.",
    "map.branchHint": "Only this coordinator's direct agents are shown. Switch views for delegation, required results, or on-demand data.",
    "map.hiddenDirectAgents": "{count} more direct agents are collapsed in this overview.",
    "map.hiddenBranchAgents": "{count} more direct agents in this branch. Search finds any agent.",
    "map.showMoreAgents": "Show 24 more",
    "map.showAllBranchAgents": "Show entire branch",
    "map.workflowStage": "Stage {count}",
    "map.unassignedAgents": "{count} agents outside the delegation graph",
    "map.openUnassigned": "View on map",
    "map.noRelations": "No links of this type in this branch.",
    "map.focusSelection": "Center selected agent",
    "map.panHint": "Scroll or drag empty canvas to move · Ctrl/⌘ + scroll to zoom",
    "map.zoomIn": "Zoom in",
    "map.zoomOut": "Zoom out",
    "map.fit": "Fit all nodes",
    "map.fitShort": "Fit",
    "map.arrange": "Restore automatic layout",
    "map.arrangeShort": "Arrange",
    "map.layers": "Connection type",
    "map.delegation": "Delegation",
    "map.dependencies": "Requires result",
    "map.delegationMeaning": "May launch agent",
    "map.dependenciesMeaning": "Requires result before start",
    "map.contextProvidersMeaning": "May request data via coordinator",
    "map.fullRoster": "All agent relationships",
    "map.graphCount": "{agents} agents · {links} links",
    "map.connectedAgents": "{count} connected agents",
    "map.searchResults": "{count} matching agents",
    "map.directAgents": "{count} direct agents",
    "map.graph": "Agent graph",
    "map.details": "Map details",
    "map.inspect": "Inspect {name}",
    "map.move": "Move {name}. Use arrow keys.",
    "map.moveHint": "Drag to arrange; arrow keys to move",
    "map.openNamedBranch": "Open {name} branch",
    "map.openBranch": "Open branch",
    "map.prerequisitePort": "Select {name} as prerequisite",
    "map.consumerPort": "Make {name} depend on {source}",
    "map.contextProviderPort": "Select {name} as a data provider through this coordinator",
    "map.contextConsumerPort": "Let {name} request data from {source} through this coordinator",
    "map.kindMain": "MAIN",
    "map.kindOrchestrator": "ORCHESTRATOR",
    "map.kindMissing": "MISSING",
    "map.kindAgent": "AGENT",
    "map.noMatches": "No matching agents",
    "map.statusEnabled": "enabled",
    "map.statusDisabled": "disabled",
    "map.noDescription": "No description",
    "map.openProfile": "Open profile",
    "map.missingProfile": "This profile is no longer available.",
    "map.rootLegacy": "Root session · all enabled (legacy)",
    "map.rootConfigured": "Root session · {count} configured direct agents",
    "map.skills": "Skills",
    "map.extensionTools": "Extension tools",
    "map.noneAssigned": "None assigned",
    "map.allAvailableLegacy": "All available (legacy)",
    "map.directDelegates": "Direct delegates",
    "map.requiredResults": "Required results",
    "map.availableProviders": "Available data providers",
    "map.connections": "Connections",
    "map.coordinators": "Coordinators of this agent",
    "map.coordinatorHint": "Choose the coordinator whose connections you want to see or edit. The same agent may have different connections under different coordinators.",
    "map.chooseCoordinator": "Choose coordinator…",
    "map.noCoordinators": "No coordinator currently allows this agent as a direct child. Add it to a coordinator before linking it to a reader.",
    "map.openMainBranch": "Open Main branch",
    "map.providersForSelected": "Data sources for {name}",
    "map.providerLabel": "May ask {name} via coordinator",
    "map.requiredBySelected": "Results required by {name}",
    "map.prerequisiteLabel": "Needs {name} before start",
    "map.prerequisiteMeaning": "An amber arrow means the source must finish successfully before the target starts.",
    "map.contextProviderHint": "A green arrow means the target can ask the coordinator for data; the coordinator launches the source and passes its result to the target. It does not force the source to run beforehand.",
    "map.addSiblingFirst": "Add another direct agent to this coordinator to link it here.",
    "map.linkKind": "Connection to create on the canvas",
    "map.connectHint": "Choose a connection type, then select the source and target ports. You can also use the form below.",
    "map.overviewOwner": "This link belongs to {name}.",
    "map.openItsBranch": "Open its branch",
    "map.selectToEdit": "Select Main or an orchestrator to edit its own links.",
    "map.delegateHint": "An allowed agent can be launched by this orchestrator. Links do not launch agents.",
    "map.dependencyHint": "A consumer waits for the producer’s result. Select the source port, then the consumer’s port.",
    "map.legacyWarning": "Main currently allows every enabled agent. To edit its connections, create an explicit list of direct agents. This starts empty; add only the agents Main should be allowed to launch, then save.",
    "map.restrictMain": "Create explicit Main agent list",
    "map.otherOwner": "This link belongs to {name}. Open that orchestrator to change it.",
    "map.removeLink": "Remove link {source} to {target}",
    "map.removeTypedLink": "Remove {kind} link {source} to {target}",
    "map.addDirectAgent": "Add direct agent",
    "map.chooseAgent": "Choose agent…",
    "map.addLink": "Add link",
    "map.producer": "Producer",
    "map.chooseProducer": "Choose producer…",
    "map.consumer": "Consumer",
    "map.chooseConsumer": "Choose consumer…",
    "map.addRequirement": "Add requirement",
    "map.readOnly": "This profile is read-only here.",
    "map.enableOrchestration": "Enable orchestration in the agent profile first.",
    "map.layoutNote": "Edits require Save in settings. Moving cards only changes this map layout.",
    "map.errorChooseProfile": "Choose an available agent profile.",
    "map.errorSelfChild": "An orchestrator cannot delegate to itself.",
    "map.errorDirectChildren": "Both agents must be direct children of this orchestrator.",
    "map.errorSelfDependency": "An agent cannot depend on itself.",
    "map.errorMaxPrerequisites": "An agent may have at most 8 sources across both connection types.",
    "map.errorCycle": "This link creates a dependency cycle.",
    "map.errorOwnerUnavailable": "Open the coordinator branch before editing its links.",
    "agents.close": "Close",
    "agents.discardChanges": "Discard unsaved changes?",
    "agents.map": "Map",
    "agents.openMap": "Open orchestration map",
    "agents.mapForAgent": "Show connections on map",
    "agents.unsavedMapNotice": "Unsaved settings remain in their tabs. Return there to review and save them.",
    "agents.customizeBuiltIn": "Customize built-in",
    "agents.customizeBuiltInHelp": "Saving creates a global copy with the same ID. It takes priority over the built-in profile unless a project profile also uses that ID. The built-in stays unchanged.",
    "agents.nestedForegroundHint": "When launched by another sub-agent, this agent runs in the foreground regardless of its default.",
    "agents.fastMode": "Fast mode",
    "agents.fastModeDescription": "Faster responses for supported native OpenAI Responses/Codex models. It may incur additional cost; unsupported models report an error at launch.",
    "agents.tooManySources": "{name} may have at most 8 sources across both connection types.",
    "agents.profiles": "Profiles",
    "agents.mapMainScope": "Main settings on this map apply to every project.",
    "agents.mapRepositorySource": "Editing shared Main policy in the repository",
    "agents.mapProjectSource": "Editing Main policy for this project",
    "agents.mapGlobalSource": "Editing Main policy on this machine",
    ...
    "agents.settingsSources": "Effective sources: Agent switch {enabled}, concurrency {concurrency}, built-in profiles {profiles}.",
    "agents.rosterConnected": "Git roster connected.",
    "agents.rosterConnectedDescription": "{count} agent profiles from {path}.",
    "agents.rosterUnavailable": "Git roster unavailable.",
    "agents.rosterUnavailableDescription": "This Pi Web process cannot see your repository agents or skills. Set PI_WEB_ROSTER_ROOT to the absolute path of the checkout's orchestration directory and restart Pi Web.",
    "agents.settingsSaveTo": "Save settings to",
    "agents.settingsRepo": "Repository",
    "agents.settingsLocal": "Local experiment",
    ...
    "agents.concurrentRange": "Enter a whole number between 1 and 32.",
    ...
    "agents.orchestrator": "Orchestrator (can delegate)",
    "agents.orchestratorDescription": "Orchestrators can delegate only to the agents selected below. You can assign specific skills; file and extension tools stay disabled.",
    "agents.allowedChildren": "Allowed child agents",
    "agents.searchChildren": "Search agents...",
    "agents.searchProfiles": "Filter agent profiles...",
    "agents.noAvailableChildren": "No enabled agents available",
    "agents.noMatchingChildren": "No matching agents",
    "agents.unavailableChildren": "Unavailable child agents: {names}. Remove or enable them before saving.",
    "agents.unavailableChild": "{name} (unavailable)",
    "agents.dependencies": "Agent depends on…",
    "agents.dependenciesDescription": "Select the agents whose successful results are required before each agent can run.",
    "agents.dependenciesNeedChildren": "Select at least two child agents to add a dependency.",
    "agents.dependsOnAgent": "Agents required by {name}",
    "agents.dependsOnCount": "depends on {count}",
    "agents.noDependencies": "no dependencies",
    "agents.unknownDependencies": "Dependencies refer to unselected agents: {names}.",
    "agents.selfDependency": "An agent cannot depend on itself: {name}.",
    "agents.cyclicDependencies": "Dependency cycle: {names}. Remove a dependency before saving.",
    "agents.removeInvalidDependencies": "Remove invalid links",
    "agents.configurationErrorTitle": "Invalid agent configuration",
    "agents.configurationErrorHelp": "Edit this profile, then save it as an orchestrator or specialist to replace the invalid policy.",
    ...
    "agents.scope.roster": "shared roster (Git)",
    ...
    "agentSwitcher.status.needs_context": "Needs context",
    ...
    "session.cost": "Cost",
    "session.agentCost": "Agent",
    "session.familyCost": "All agents",
    "session.familyCostHelp": "Main and all nested agents, including finished agents; forks are separate.",
    "session.partialCost": "Total updating or some agent costs unavailable",
