...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.generalDescription": "Choose how Pi Web looks.",
    "main.description": "With a Git-owned Main configuration and enabled sub-agents, new chats start as Task dispatchers. Existing sessions keep their mode. Switch to a standard session in a new chat if needed.",
    "main.model": "Model",
    "main.thinking": "Thinking",
    "main.fastMode": "Fast mode",
    "main.additionalInstructions": "Additional instructions",
    "main.basePrompt": "Fixed dispatcher instructions",
    "main.path": "Repository configuration",
    "main.save": "Save",
    "main.saving": "Saving...",
    "main.reload": "Reload",
    "main.loading": "Loading Main settings...",
    "main.saved": "Saved for new sessions",
    "main.unsavedChanges": "Discard unsaved Main changes?",
    "main.conflict": "Main settings changed elsewhere. Reload before saving.",
    "main.available": "Available for new sessions",
    "main.unavailable": "Enable Pi Web built-in sub-agents to use this dispatcher.",
    "main.repositoryUnavailable": "Repository Main configuration is unavailable. Run Pi Web from its Git checkout or configure a repository roster.",
    ...
    "agents.showOrchestrationProfiles": "Browse orchestration profiles",
    ...
    "agents.settingsEditScope": "Save sub-agent settings to",
    "agents.localOverrides": "Local settings override repository defaults; changes saved to the repository may not take effect until local overrides are removed.",
    ...
    "agents.fastModeDescription": "Use priority processing for supported OpenAI Responses models. Estimated session cost may omit the Fast surcharge.",
    "agents.hostPolicy": "Tools, resources and delegation for this task role are fixed by the host. Model, thinking, Fast mode and instructions are stored in Git.",
    ...
    "agents.scope.roster": "repository",
    ...
    "agentSwitcher.expand": "Expand agent runs",
    "agentSwitcher.collapse": "Collapse agent runs",
    ...
    "session.cost": "Cost",
    "session.agentCost": "Agent estimate",
    "session.familyCost": "Session family estimate",
    "session.taskCost": "Task agents estimate",
    "session.taskCostHelp": "Task total includes only agents linked to this task; Main's spend is shared across tasks.",
    "session.partialCost": "Partial total; some agents have unknown cost",
    "session.familyCostHelp": "Includes Main and its sub-agents. Forks count as separate sessions; provider billing is authoritative.",
    ...
    "chat.mainDispatcher": "Task dispatcher",
    "chat.mainDispatcherHint": "New Task dispatcher sessions use the model, thinking level and Fast mode from Settings → Main. Requires Pi Web sub-agents to be enabled.",
    "chat.dispatcherSession": "Task dispatcher · delegates work",
    "chat.standardSession": "Standard session · direct tools",
    "chat.standardSessionHint": "This session can use tools directly. Start a new Task dispatcher session to delegate engineering work to its task owner.",
    "chat.loadingSessionMode": "Loading session mode…",
