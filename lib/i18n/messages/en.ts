...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.mainDispatcher": "Luna dispatcher",
    "chat.mainDispatcherHint": "New session: Luna High Fast delegates through Agent tools. Requires Pi Web sub-agents to be enabled.",
