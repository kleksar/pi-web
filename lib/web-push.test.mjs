...
test("notifySessionComplete sends English payloads, including to legacy subscriptions", async () => {
...
test("notifySessionComplete uses the English generic title for legacy subscriptions", async () => {
...
test("localeText falls back to English for removed and unknown locales", () => {
  assert.equal(localeText("zh-CN", "taskFinished"), "Task finished.");
