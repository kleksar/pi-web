...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "main.globalDescription": "Main's skills, callable extension tools, and direct agents apply across projects. System instructions may have a project-specific file.",
    ...
    "main.resources": "Skills and extension tools",
    "main.resourcesDescription": "Choose the skills Main sees and the extension tools it can call. Skill instructions do not grant tool permissions. Legacy settings still expose all resources until you make a selection.",
