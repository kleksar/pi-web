...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "mainPrompt.description": "Edit the APPEND_SYSTEM.md file used by Main. Project and global files are alternatives; a trusted project file takes precedence.",
    "mainPrompt.loading": "Loading prompt…",
    "mainPrompt.scope": "Prompt file scope",
    "mainPrompt.global": "Global",
