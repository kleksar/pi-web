...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "map.legacyWarning": "Main currently allows every enabled agent. Saving the first link change creates an explicit list; agents created later will need to be added to it.",
    ...
    "map.errorMaxPrerequisites": "An agent may have at most 8 prerequisites.",
